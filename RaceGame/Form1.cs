...
namespace RaceGame
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Race()
        {
            ...
            punter[0].GuyName = "Joe";
            punter[1].GuyName = "Bob";
            punter[2].GuyName = "Al";



            // ** Binds the Radio buttons control between Class & Radio button Name **
            punter[0].MyRadioButton = rbJoe;
            punter[1].MyRadioButton = rbBob;
            punter[2].MyRadioButton = rbAl;

            // ** Binds the labels with radio buttons via punter number as Tag **
            punter[0].myLabel = lblJoe;
            punter[1].myLabel = lblBob;
            punter[2].myLabel = lblAl;
            ...
            while (NoWinner)
            {
...

                {
                    if (animal[i].Run())
                    {
                        ...
                        MessageBox.Show(text: "We have a winner - " + winningAnimal);
                        foreach (Punter punter in punter)
                        {
        ...
        private void btnResetGame_Click(object sender, EventArgs e)
        {
            ...
            rbBob.Enabled = true;
            rbAl.Enabled = true;
            rbJoe.ForeColor = Color.Black;
            rbBob.ForeColor = Color.Black;
            rbAl.ForeColor = Color.Black;
            lblJoe.ForeColor = Color.Black;
            lblBob.ForeColor = Color.Black;
            lblAl.ForeColor = Color.Black;
            Race();
            lblMinimumBet.Text = string.Format("Minimum bet {0:c}", (int)BetAmount.Minimum);
        }
